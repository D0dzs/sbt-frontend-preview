const FilmStripElement = ({ imageURL }) => {
  return (
    <div className="relative flex flex-col shrink-0 overflow-hidden -m-px">
      <img src={'/hero/lfilmstrip.svg'} alt="Filmstrip" className="z-10 h-full dark:hidden" />
      <img src={'/hero/dfilmstrip.svg'} alt="Filmstrip" className="z-10 hidden h-full dark:block" />
