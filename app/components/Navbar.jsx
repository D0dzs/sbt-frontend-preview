...
const Navbar = ({ className, ...props }) => {
  return (
    <nav className={`${cn('z-10', className)}`} {...props}>
      <div className="outline-bme-dsecondary/10 dark:outline-bme-lsecondary/10 from-bme-white/50 to-bme-white/30 shadow-bme-dprimary/30 h-20 w-[60vw] rounded-full bg-linear-to-t px-8 shadow-md outline-2 backdrop-blur-sm">
